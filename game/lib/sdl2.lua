...
enum
{
    ...
    SDL_KEY_CAPSLOCK = (SDL_SCANCODE_CAPSLOCK | (1<<30)),
    SDL_KEY_F1 = (SDL_SCANCODE_F1 | (1<<30)),
    SDL_KEY_F2 = (SDL_SCANCODE_F2 | (1<<30)),
    SDL_KEY_F3 = (SDL_SCANCODE_F3 | (1<<30)),
    SDL_KEY_F4 = (SDL_SCANCODE_F4 | (1<<30)),
    SDL_KEY_F5 = (SDL_SCANCODE_F5 | (1<<30)),
    SDL_KEY_F6 = (SDL_SCANCODE_F6 | (1<<30)),
    SDL_KEY_F7 = (SDL_SCANCODE_F7 | (1<<30)),
    SDL_KEY_F8 = (SDL_SCANCODE_F8 | (1<<30)),
    SDL_KEY_F9 = (SDL_SCANCODE_F9 | (1<<30)),
    SDL_KEY_F10 = (SDL_SCANCODE_F10 | (1<<30)),
    SDL_KEY_F11 = (SDL_SCANCODE_F11 | (1<<30)),
    SDL_KEY_F12 = (SDL_SCANCODE_F12 | (1<<30)),
    SDL_KEY_PRINTSCREEN = (SDL_SCANCODE_PRINTSCREEN | (1<<30)),
    SDL_KEY_SCROLLLOCK = (SDL_SCANCODE_SCROLLLOCK | (1<<30)),
    SDL_KEY_PAUSE = (SDL_SCANCODE_PAUSE | (1<<30)),
    SDL_KEY_INSERT = (SDL_SCANCODE_INSERT | (1<<30)),
    SDL_KEY_HOME = (SDL_SCANCODE_HOME | (1<<30)),
    SDL_KEY_PAGEUP = (SDL_SCANCODE_PAGEUP | (1<<30)),
    SDL_KEY_DELETE = '\177',
    SDL_KEY_END = (SDL_SCANCODE_END | (1<<30)),
    SDL_KEY_PAGEDOWN = (SDL_SCANCODE_PAGEDOWN | (1<<30)),
    SDL_KEY_RIGHT = (SDL_SCANCODE_RIGHT | (1<<30)),
    SDL_KEY_LEFT = (SDL_SCANCODE_LEFT | (1<<30)),
    SDL_KEY_DOWN = (SDL_SCANCODE_DOWN | (1<<30)),
    SDL_KEY_UP = (SDL_SCANCODE_UP | (1<<30)),
    SDL_KEY_NUMLOCKCLEAR = (SDL_SCANCODE_NUMLOCKCLEAR | (1<<30)),
    SDL_KEY_KP_DIVIDE = (SDL_SCANCODE_KP_DIVIDE | (1<<30)),
    SDL_KEY_KP_MULTIPLY = (SDL_SCANCODE_KP_MULTIPLY | (1<<30)),
    SDL_KEY_KP_MINUS = (SDL_SCANCODE_KP_MINUS | (1<<30)),
    SDL_KEY_KP_PLUS = (SDL_SCANCODE_KP_PLUS | (1<<30)),
    SDL_KEY_KP_ENTER = (SDL_SCANCODE_KP_ENTER | (1<<30)),
    SDL_KEY_KP_1 = (SDL_SCANCODE_KP_1 | (1<<30)),
    SDL_KEY_KP_2 = (SDL_SCANCODE_KP_2 | (1<<30)),
    SDL_KEY_KP_3 = (SDL_SCANCODE_KP_3 | (1<<30)),
    SDL_KEY_KP_4 = (SDL_SCANCODE_KP_4 | (1<<30)),
    SDL_KEY_KP_5 = (SDL_SCANCODE_KP_5 | (1<<30)),
    SDL_KEY_KP_6 = (SDL_SCANCODE_KP_6 | (1<<30)),
    SDL_KEY_KP_7 = (SDL_SCANCODE_KP_7 | (1<<30)),
    SDL_KEY_KP_8 = (SDL_SCANCODE_KP_8 | (1<<30)),
    SDL_KEY_KP_9 = (SDL_SCANCODE_KP_9 | (1<<30)),
    SDL_KEY_KP_0 = (SDL_SCANCODE_KP_0 | (1<<30)),
    SDL_KEY_KP_PERIOD = (SDL_SCANCODE_KP_PERIOD | (1<<30)),
    SDL_KEY_APPLICATION = (SDL_SCANCODE_APPLICATION | (1<<30)),
    SDL_KEY_POWER = (SDL_SCANCODE_POWER | (1<<30)),
    SDL_KEY_KP_EQUALS = (SDL_SCANCODE_KP_EQUALS | (1<<30)),
    SDL_KEY_F13 = (SDL_SCANCODE_F13 | (1<<30)),
    SDL_KEY_F14 = (SDL_SCANCODE_F14 | (1<<30)),
    SDL_KEY_F15 = (SDL_SCANCODE_F15 | (1<<30)),
    SDL_KEY_F16 = (SDL_SCANCODE_F16 | (1<<30)),
    SDL_KEY_F17 = (SDL_SCANCODE_F17 | (1<<30)),
    SDL_KEY_F18 = (SDL_SCANCODE_F18 | (1<<30)),
    SDL_KEY_F19 = (SDL_SCANCODE_F19 | (1<<30)),
    SDL_KEY_F20 = (SDL_SCANCODE_F20 | (1<<30)),
    SDL_KEY_F21 = (SDL_SCANCODE_F21 | (1<<30)),
    SDL_KEY_F22 = (SDL_SCANCODE_F22 | (1<<30)),
    SDL_KEY_F23 = (SDL_SCANCODE_F23 | (1<<30)),
    SDL_KEY_F24 = (SDL_SCANCODE_F24 | (1<<30)),
    SDL_KEY_EXECUTE = (SDL_SCANCODE_EXECUTE | (1<<30)),
    SDL_KEY_HELP = (SDL_SCANCODE_HELP | (1<<30)),
    SDL_KEY_MENU = (SDL_SCANCODE_MENU | (1<<30)),
    SDL_KEY_SELECT = (SDL_SCANCODE_SELECT | (1<<30)),
    SDL_KEY_STOP = (SDL_SCANCODE_STOP | (1<<30)),
    SDL_KEY_AGAIN = (SDL_SCANCODE_AGAIN | (1<<30)),
    SDL_KEY_UNDO = (SDL_SCANCODE_UNDO | (1<<30)),
    SDL_KEY_CUT = (SDL_SCANCODE_CUT | (1<<30)),
    SDL_KEY_COPY = (SDL_SCANCODE_COPY | (1<<30)),
    SDL_KEY_PASTE = (SDL_SCANCODE_PASTE | (1<<30)),
    SDL_KEY_FIND = (SDL_SCANCODE_FIND | (1<<30)),
    SDL_KEY_MUTE = (SDL_SCANCODE_MUTE | (1<<30)),
    SDL_KEY_VOLUMEUP = (SDL_SCANCODE_VOLUMEUP | (1<<30)),
    SDL_KEY_VOLUMEDOWN = (SDL_SCANCODE_VOLUMEDOWN | (1<<30)),
    SDL_KEY_KP_COMMA = (SDL_SCANCODE_KP_COMMA | (1<<30)),
    SDL_KEY_KP_EQUALSAS400 =
        (SDL_SCANCODE_KP_EQUALSAS400 | (1<<30)),
    SDL_KEY_ALTERASE = (SDL_SCANCODE_ALTERASE | (1<<30)),
    SDL_KEY_SYSREQ = (SDL_SCANCODE_SYSREQ | (1<<30)),
    SDL_KEY_CANCEL = (SDL_SCANCODE_CANCEL | (1<<30)),
    SDL_KEY_CLEAR = (SDL_SCANCODE_CLEAR | (1<<30)),
    SDL_KEY_PRIOR = (SDL_SCANCODE_PRIOR | (1<<30)),
    SDL_KEY_RETURN2 = (SDL_SCANCODE_RETURN2 | (1<<30)),
    SDL_KEY_SEPARATOR = (SDL_SCANCODE_SEPARATOR | (1<<30)),
    SDL_KEY_OUT = (SDL_SCANCODE_OUT | (1<<30)),
    SDL_KEY_OPER = (SDL_SCANCODE_OPER | (1<<30)),
    SDL_KEY_CLEARAGAIN = (SDL_SCANCODE_CLEARAGAIN | (1<<30)),
    SDL_KEY_CRSEL = (SDL_SCANCODE_CRSEL | (1<<30)),
    SDL_KEY_EXSEL = (SDL_SCANCODE_EXSEL | (1<<30)),
    SDL_KEY_KP_00 = (SDL_SCANCODE_KP_00 | (1<<30)),
    SDL_KEY_KP_000 = (SDL_SCANCODE_KP_000 | (1<<30)),
    SDL_KEY_THOUSANDSSEPARATOR =
        (SDL_SCANCODE_THOUSANDSSEPARATOR | (1<<30)),
    SDL_KEY_DECIMALSEPARATOR =
        (SDL_SCANCODE_DECIMALSEPARATOR | (1<<30)),
    SDL_KEY_CURRENCYUNIT = (SDL_SCANCODE_CURRENCYUNIT | (1<<30)),
    SDL_KEY_CURRENCYSUBUNIT =
        (SDL_SCANCODE_CURRENCYSUBUNIT | (1<<30)),
    SDL_KEY_KP_LEFTPAREN = (SDL_SCANCODE_KP_LEFTPAREN | (1<<30)),
    SDL_KEY_KP_RIGHTPAREN = (SDL_SCANCODE_KP_RIGHTPAREN | (1<<30)),
    SDL_KEY_KP_LEFTBRACE = (SDL_SCANCODE_KP_LEFTBRACE | (1<<30)),
    SDL_KEY_KP_RIGHTBRACE = (SDL_SCANCODE_KP_RIGHTBRACE | (1<<30)),
    SDL_KEY_KP_TAB = (SDL_SCANCODE_KP_TAB | (1<<30)),
    SDL_KEY_KP_BACKSPACE = (SDL_SCANCODE_KP_BACKSPACE | (1<<30)),
    SDL_KEY_KP_A = (SDL_SCANCODE_KP_A | (1<<30)),
    SDL_KEY_KP_B = (SDL_SCANCODE_KP_B | (1<<30)),
    SDL_KEY_KP_C = (SDL_SCANCODE_KP_C | (1<<30)),
    SDL_KEY_KP_D = (SDL_SCANCODE_KP_D | (1<<30)),
    SDL_KEY_KP_E = (SDL_SCANCODE_KP_E | (1<<30)),
    SDL_KEY_KP_F = (SDL_SCANCODE_KP_F | (1<<30)),
    SDL_KEY_KP_XOR = (SDL_SCANCODE_KP_XOR | (1<<30)),
    SDL_KEY_KP_POWER = (SDL_SCANCODE_KP_POWER | (1<<30)),
    SDL_KEY_KP_PERCENT = (SDL_SCANCODE_KP_PERCENT | (1<<30)),
    SDL_KEY_KP_LESS = (SDL_SCANCODE_KP_LESS | (1<<30)),
    SDL_KEY_KP_GREATER = (SDL_SCANCODE_KP_GREATER | (1<<30)),
    SDL_KEY_KP_AMPERSAND = (SDL_SCANCODE_KP_AMPERSAND | (1<<30)),
    SDL_KEY_KP_DBLAMPERSAND =
        (SDL_SCANCODE_KP_DBLAMPERSAND | (1<<30)),
    SDL_KEY_KP_VERTICALBAR =
        (SDL_SCANCODE_KP_VERTICALBAR | (1<<30)),
    SDL_KEY_KP_DBLVERTICALBAR =
        (SDL_SCANCODE_KP_DBLVERTICALBAR | (1<<30)),
    SDL_KEY_KP_COLON = (SDL_SCANCODE_KP_COLON | (1<<30)),
    SDL_KEY_KP_HASH = (SDL_SCANCODE_KP_HASH | (1<<30)),
    SDL_KEY_KP_SPACE = (SDL_SCANCODE_KP_SPACE | (1<<30)),
    SDL_KEY_KP_AT = (SDL_SCANCODE_KP_AT | (1<<30)),
    SDL_KEY_KP_EXCLAM = (SDL_SCANCODE_KP_EXCLAM | (1<<30)),
    SDL_KEY_KP_MEMSTORE = (SDL_SCANCODE_KP_MEMSTORE | (1<<30)),
    SDL_KEY_KP_MEMRECALL = (SDL_SCANCODE_KP_MEMRECALL | (1<<30)),
    SDL_KEY_KP_MEMCLEAR = (SDL_SCANCODE_KP_MEMCLEAR | (1<<30)),
    SDL_KEY_KP_MEMADD = (SDL_SCANCODE_KP_MEMADD | (1<<30)),
    SDL_KEY_KP_MEMSUBTRACT =
        (SDL_SCANCODE_KP_MEMSUBTRACT | (1<<30)),
    SDL_KEY_KP_MEMMULTIPLY =
        (SDL_SCANCODE_KP_MEMMULTIPLY | (1<<30)),
    SDL_KEY_KP_MEMDIVIDE = (SDL_SCANCODE_KP_MEMDIVIDE | (1<<30)),
    SDL_KEY_KP_PLUSMINUS = (SDL_SCANCODE_KP_PLUSMINUS | (1<<30)),
    SDL_KEY_KP_CLEAR = (SDL_SCANCODE_KP_CLEAR | (1<<30)),
    SDL_KEY_KP_CLEARENTRY = (SDL_SCANCODE_KP_CLEARENTRY | (1<<30)),
    SDL_KEY_KP_BINARY = (SDL_SCANCODE_KP_BINARY | (1<<30)),
    SDL_KEY_KP_OCTAL = (SDL_SCANCODE_KP_OCTAL | (1<<30)),
    SDL_KEY_KP_DECIMAL = (SDL_SCANCODE_KP_DECIMAL | (1<<30)),
    SDL_KEY_KP_HEXADECIMAL =
        (SDL_SCANCODE_KP_HEXADECIMAL | (1<<30)),
    SDL_KEY_LCTRL = (SDL_SCANCODE_LCTRL | (1<<30)),
    SDL_KEY_LSHIFT = (SDL_SCANCODE_LSHIFT | (1<<30)),
    SDL_KEY_LALT = (SDL_SCANCODE_LALT | (1<<30)),
    SDL_KEY_LGUI = (SDL_SCANCODE_LGUI | (1<<30)),
    SDL_KEY_RCTRL = (SDL_SCANCODE_RCTRL | (1<<30)),
    SDL_KEY_RSHIFT = (SDL_SCANCODE_RSHIFT | (1<<30)),
    SDL_KEY_RALT = (SDL_SCANCODE_RALT | (1<<30)),
    SDL_KEY_RGUI = (SDL_SCANCODE_RGUI | (1<<30)),
    SDL_KEY_MODE = (SDL_SCANCODE_MODE | (1<<30)),
    SDL_KEY_AUDIONEXT = (SDL_SCANCODE_AUDIONEXT | (1<<30)),
    SDL_KEY_AUDIOPREV = (SDL_SCANCODE_AUDIOPREV | (1<<30)),
    SDL_KEY_AUDIOSTOP = (SDL_SCANCODE_AUDIOSTOP | (1<<30)),
    SDL_KEY_AUDIOPLAY = (SDL_SCANCODE_AUDIOPLAY | (1<<30)),
    SDL_KEY_AUDIOMUTE = (SDL_SCANCODE_AUDIOMUTE | (1<<30)),
    SDL_KEY_MEDIASELECT = (SDL_SCANCODE_MEDIASELECT | (1<<30)),
    SDL_KEY_WWW = (SDL_SCANCODE_WWW | (1<<30)),
    SDL_KEY_MAIL = (SDL_SCANCODE_MAIL | (1<<30)),
    SDL_KEY_CALCULATOR = (SDL_SCANCODE_CALCULATOR | (1<<30)),
    SDL_KEY_COMPUTER = (SDL_SCANCODE_COMPUTER | (1<<30)),
    SDL_KEY_AC_SEARCH = (SDL_SCANCODE_AC_SEARCH | (1<<30)),
    SDL_KEY_AC_HOME = (SDL_SCANCODE_AC_HOME | (1<<30)),
    SDL_KEY_AC_BACK = (SDL_SCANCODE_AC_BACK | (1<<30)),
    SDL_KEY_AC_FORWARD = (SDL_SCANCODE_AC_FORWARD | (1<<30)),
    SDL_KEY_AC_STOP = (SDL_SCANCODE_AC_STOP | (1<<30)),
    SDL_KEY_AC_REFRESH = (SDL_SCANCODE_AC_REFRESH | (1<<30)),
    SDL_KEY_AC_BOOKMARKS = (SDL_SCANCODE_AC_BOOKMARKS | (1<<30)),
    SDL_KEY_BRIGHTNESSDOWN =
        (SDL_SCANCODE_BRIGHTNESSDOWN | (1<<30)),
    SDL_KEY_BRIGHTNESSUP = (SDL_SCANCODE_BRIGHTNESSUP | (1<<30)),
    SDL_KEY_DISPLAYSWITCH = (SDL_SCANCODE_DISPLAYSWITCH | (1<<30)),
    SDL_KEY_KBDILLUMTOGGLE =
        (SDL_SCANCODE_KBDILLUMTOGGLE | (1<<30)),
    SDL_KEY_KBDILLUMDOWN = (SDL_SCANCODE_KBDILLUMDOWN | (1<<30)),
    SDL_KEY_KBDILLUMUP = (SDL_SCANCODE_KBDILLUMUP | (1<<30)),
    SDL_KEY_EJECT = (SDL_SCANCODE_EJECT | (1<<30)),
    SDL_KEY_SLEEP = (SDL_SCANCODE_SLEEP | (1<<30))
};
typedef enum
{
...
typedef void (*SDL_LogOutputFunction)(void *userdata, int category, int priority, const char *message);
...
local module = ffi.load'SDL2'
local sdl = setmetatable( {}, {__index = function(_, k) return module['SDL_' .. k] end} )
